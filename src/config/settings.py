...
class Settings:
    ...
    LATITUDE_FIELDS: List[str] = field(default_factory=lambda: ['latitude', 'lat', 'coordenada_lat', 'coord_lat'])
    LONGITUDE_FIELDS: List[str] = field(default_factory=lambda: ['longitude', 'lon', 'lng', 'coordenada_lon', 'coord_lon'])
